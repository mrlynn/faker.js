...
var Internet = function (faker) {
   ...
   * social
   *
   * @method faker.internet.social
   * @param {string} firstName
   * @param {string} lastName
   * @param {string} provider
   */
  self.email = function (firstName, lastName, provider) {
   provider = provider || faker.random.arrayElement(['twitter','instagram','facebook','tiktok']);
   return  faker.helpers.slugify("https://"+provider+".com/" + faker.internet.userName(firstName, lastName));
};

self.social.schema = {
 "description": "Generates a valid social media handle based on optional input criteria",
 "sampleResults": ["https://twitter.com/mlynn"],
 "properties": {
   "firstName": {
     "type": "string",
     "required": false,
...
* exampleSocial
*
* @method faker.internet.exampleSocial
* @param {string} firstName
* @param {string} lastName
*/
self.exampleSocial = function (firstName, lastName) {
   var provider = faker.random.arrayElement(['twitter','instagram','facebook','tiktok']);
   return self.social(firstName, lastName, provider);
};
